				...
				<div class="full-width panel mdl-shadow--2dp">
					...
					<div class="full-width panel-content">
						<form>
							<div class="mdl-grid">
								<div class="mdl-cell mdl-cell--12-col">
		                            <legend class="text-condensedLight"><i class="zmdi zmdi-border-color"></i> &nbsp; OPCIONES A ELEGIR</legend><br>
		                        </div>
                                <div class="mdl-cell mdl-cell--12-col">
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<select name="" id="idFuncion" class="mdl-textfield__input">
							...
							<p class="text-center">
								...
								<div class="mdl-tooltip" for="btn-addCompany">Seleccionar función</div>
							</p>
						</form>
					</div>
				</div>
